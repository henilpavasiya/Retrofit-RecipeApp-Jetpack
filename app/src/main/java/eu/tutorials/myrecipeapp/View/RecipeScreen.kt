    ...
    Box(modifier = Modifier.fillMaxSize()){
        when{
            ...
            viewstate.error != null  || viewmealstate.error != null->{
                ...
                CategoryScreen(categories = viewstate.list, meals = viewmealstate.list)
            }
        }
    }
}  
...
@Composable
fun CategoryScreen(categories: List<Category>, meals: List<Meal>){
        ...
        horizontalAlignment = Alignment.CenterHorizontally)
    {
        ...
        Row(
           ...
           horizontalArrangement = Arrangement.Center
            ...
            val matchingIngredients = meals.filter { meal -> // It iterates through each item (meal) in the meals list.
